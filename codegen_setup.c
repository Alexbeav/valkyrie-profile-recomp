...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Valkyrie Profile",
    .project_root_env = "VALKYRIE_PROFILE_RECOMP_PROJECT_ROOT",
    .build_dir_env = "VALKYRIE_PROFILE_RECOMP_BUILD_DIR",
    .force_setup_env = "VALKYRIE_PROFILE_RECOMP_FORCE_SETUP",
    ...
    .exe_basename = "Valkyrie_Profile__Recompiled",
    .prepare_note =
