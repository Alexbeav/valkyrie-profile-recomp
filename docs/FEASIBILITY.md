# Valkyrie Profile feasibility binding

## Identity

- Title and region: Valkyrie Profile, USA.
- Serial: SLUS-01156.
- Source executable path: `disc/SLUS_011.56`.
- Load address: `0x80010000`.
- Entry point: `0x80010008`.
- Source disc binding: ``.
...
The clean source commit is `ff4ca4394bd444c04971941e840bfe2e04fc3025`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 313 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `ff4ca4394bd444c04971941e840bfe2e04fc3025`.
- Portfolio `valkyrie-profile/BUILDINFO.json`.
- Portfolio `valkyrie-profile/RECEIPT.md`.
